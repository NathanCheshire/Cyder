...
public class PaintWidget {
    ...
    public static void showGUI() {
        ...
        CyderFrame paintFrame = new CyderFrame(len + 100,len + DragLabel.getDefaultHeight() + 100);
        paintFrame.setTitle("Cyder Grid");
        paintFrame.setBackground(CyderIcons.defaultBackgroundLarge);

        CyderGrid cyderGrid = new CyderGrid(160, len);
        cyderGrid.setBounds(50,DragLabel.getDefaultHeight() + 50, len, len);
