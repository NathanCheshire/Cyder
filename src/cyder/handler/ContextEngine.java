...
public class ContextEngine {
    ...
    //todo this class should always be associated with an InputHandler and be able to alter the output
    // before it's passed to the ConsoleFrame's output methods
