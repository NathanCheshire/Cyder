...
public class Minecraft {
    ...
    public Minecraft() {
        ...
        minecraftFrame = new CyderFrame(1263,160, new ImageIcon("src/cyder//sys/pictures/Minecraft.png"));
        minecraftFrame.setTitlePosition(TitlePosition.CENTER);
        minecraftFrame.setTitle("Minecraft Widget");

        blockLabel = new JLabel(new ImageIcon("src/cyder//sys/pictures/Block.png"));
        blockLabel.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ImageIcon BlockIcon = new ImageIcon("src/cyder//sys/pictures/BlockEnter.gif");
            ...
            public void mouseExited(MouseEvent e) {
                ImageIcon BlockIcon = new ImageIcon("src/cyder//sys/pictures/BlockExit.gif");
                BlockIcon.getImage().flush();
                blockLabel.setIcon(BlockIcon);
            }
        });
        ...
        realmsLabel = new JLabel(new ImageIcon("src/cyder//sys/pictures/Realms.png"));
        ...
        realmsLabel.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                ImageIcon RealmsIcon = new ImageIcon("src/cyder//sys/pictures/RealmsEnter.gif");
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                ImageIcon RealmsIcon = new ImageIcon("src/cyder//sys/pictures/RealmsExit.gif");
                RealmsIcon.getImage().flush();
                realmsLabel.setIcon(RealmsIcon);
            }
        });
        ...
        chestLabel = new JLabel(new ImageIcon("src/cyder//sys/pictures/Chest.png"));
        ...
        chestLabel.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                ImageIcon ChestIcon = new ImageIcon("src/cyder//sys/pictures/ChestEnter.gif");
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                ImageIcon ChestIcon = new ImageIcon("src/cyder//sys/pictures/ChestExit.gif");
                ChestIcon.getImage().flush();
                chestLabel.setIcon(ChestIcon);
            }
        });
        ...
        hamLabel = new JLabel(new ImageIcon("src/cyder//sys/pictures/Hamburger.png"));
        ...
        hamLabel.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                ImageIcon HamIcon = new ImageIcon("src/cyder//sys/pictures/HamburgerEnter.gif");
            ...
            @Override
            public void mouseExited(MouseEvent e) {
                ImageIcon HamIcon = new ImageIcon("src/cyder//sys/pictures/HamburgerExit.gif");
                HamIcon.getImage().flush();
                hamLabel.setIcon(HamIcon);
            }
        });
        ...
        minecraftFrame.setIconImage(new ImageIcon("src/cyder//sys/pictures/Block.png").getImage());
    }
}