...
public class SystemUtil {
    ...
    private static ImageIcon cyderIcon = new ImageIcon("src/cyder//sys/pictures/CyderIcon.png");
    private static ImageIcon cyderIconBlink = new ImageIcon("src/cyder//sys/pictures/CyderIconBlink.png");
    private ImageIcon scaledCyderIcon = new ImageIcon(new ImageIcon("src/cyder//sys/pictures/CyderIcon.png").getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT));
    private ImageIcon scaledCyderIconBlink = new ImageIcon(new ImageIcon("src/cyder//sys/pictures/CyderIconBlink.png").getImage().getScaledInstance(25, 25, Image.SCALE_DEFAULT));
