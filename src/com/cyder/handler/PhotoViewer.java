...
public class PhotoViewer {
    ...
    public void start() {
        ...
        nextImage = new JLabel(new ImageIcon("src/com/cyder/sys/pictures/nextPicture1.png"));
        nextImage.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                nextImage.setIcon(new ImageIcon("src/com/cyder/sys/pictures/nextPicture2.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                nextImage.setIcon(new ImageIcon("src/com/cyder/sys/pictures/nextPicture1.png"));
            }
        });
        nextImage.setBounds(size.getIconWidth() / 2 - 50 + 100, 5, 22, 22);
        dl.add(nextImage);

        lastImage = new JLabel(new ImageIcon("src/com/cyder/sys/pictures/lastPicture1.png"));
        lastImage.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                lastImage.setIcon(new ImageIcon("src/com/cyder/sys/pictures/lastPicture2.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                lastImage.setIcon(new ImageIcon("src/com/cyder/sys/pictures/lastPicture1.png"));
            }
        });
