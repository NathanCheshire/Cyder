...
public class GenericInform {
    public static void inform(String text, String title, int width, int height) {
        try {
            CyderFrame informFrame = new CyderFrame(width,height,new ImageIcon(new ImageUtil().imageFromColor(width,height, GeneralUtil.vanila)));
            ...
            desc.setForeground(GeneralUtil.navy);
            desc.setFont(GeneralUtil.weatherFontSmall.deriveFont(22f));
